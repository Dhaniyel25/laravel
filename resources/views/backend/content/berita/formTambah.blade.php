            ...
            <div class="card-body">
                <form action="{{route('berita.prosesTambah')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        @enderror
                        <p></p>
                        <img id="tampilFoto" onerror="this.onerror=null;this.src='https://t4.ftcdn.net/jpg/04/73/25/49/360_F_473254957_bxG9yfly70B051005KABLN938GwaMQz.jpg';" src="" alt="" width="15%">
                    </div>
                    <div class="mb-3">
